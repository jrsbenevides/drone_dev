...
function[theta_p]=pitch_angle_f(theta_y,x,xd,dx,dxd,d2x,d2xd,y,yd,dy,dyd,d2y,d2yd,z,zd,dz,dzd,d2z,d2zd,quad)
...
theta_p= atan((d1*cos(theta_y)+ d2*sin(theta_y))/(d3 + g));
